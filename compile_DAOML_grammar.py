...
def main():
    ...
    grammar_generator = grammar_compiler.AntlrInvoker(pi.PIData(k_grammar_generator, [
                                                      k_grammar_path_provider]), k_grammar_path_provider, file_extension=XML_DAO_GRAMMAR_EXTENSION)
