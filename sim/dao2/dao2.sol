...
contract dao2 is IPermissionManager {
    bool internal committee_initialization_blocked;
    mapping(address => uint64) internal roles;
    uint64[21] internal role_permissions;
    uint64 internal  role0 = 33554304; // ID : 0 , control bitmask: 1111111111111111110
    uint64 internal  role1 = 67108417; // ID : 1 , control bitmask: 11111111111111111001
    uint64 internal  role2 = 67108482; // ID : 2 , control bitmask: 11111111111111111010
    uint64 internal  role3 = 67034563; // ID : 3 , control bitmask: 11111111101101110111
    uint64 internal  role4 = 66845636; // ID : 4 , control bitmask: 11111110111111101111
    uint64 internal  role5 = 62911941; // ID : 5 , control bitmask: 11101111111111010111
    uint64 internal  role6 = 50196422; // ID : 6 , control bitmask: 10111111011110111111
    uint64 internal  role7 = 67100615; // ID : 7 , control bitmask: 11111111111101111111
    uint64 internal  role8 = 64995272; // ID : 8 , control bitmask: 11110111111011111111
    uint64 internal  role9 = 67076041; // ID : 9 , control bitmask: 11111111110111111111
    uint64 internal  role10 = 66518986; // ID : 10 , control bitmask: 11111101101111111111
    uint64 internal  role11 = 66977739; // ID : 11 , control bitmask: 11111111011111111111
    uint64 internal  role12 = 65789900; // ID : 12 , control bitmask: 11111010111101111111
    uint64 internal  role13 = 66568141; // ID : 13 , control bitmask: 11111101111011111111
    uint64 internal  role14 = 66059854; // ID : 14 , control bitmask: 11111011111111111001
    uint64 internal  role15 = 55573455; // ID : 15 , control bitmask: 11010011111111101111
    uint64 internal  role16 = 62914512; // ID : 16 , control bitmask: 11101111111111111111
    uint64 internal  role17 = 58719185; // ID : 17 , control bitmask: 11011111111111101111
    uint64 internal  role18 = 50323410; // ID : 18 , control bitmask: 10111111111101111111
    uint64 internal  role19 = 33152979; // ID : 19 , control bitmask: 1111110011101111111
    uint64 internal  dao2Owner = 20; // ID : 20 , control bitmask: 0
 //Events
    ...
    constructor(
        ...
        role_permissions[dao2Owner & 63] = 0;

roles[msg.sender] = dao2Owner;
}
    function initializeCommittees() external {
        require(roles[msg.sender] == dao2Owner && committee_initialization_blocked == false && , "Invalid committee initialization");
