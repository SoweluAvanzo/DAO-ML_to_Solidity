...
contract dao1 is IPermissionManager {
    bool internal committee_initialization_blocked;
    mapping(address => uint64) internal roles;
    uint64[21] internal role_permissions;
    uint64 internal  role0 = 62865152; // ID : 0 , control bitmask: 11101111110011111100
    uint64 internal  role1 = 38318401; // ID : 1 , control bitmask: 10010010001011000101
    uint64 internal  role2 = 46135426; // ID : 2 , control bitmask: 10101111111111100010
    uint64 internal  role3 = 59899331; // ID : 3 , control bitmask: 11100100011111110111
    uint64 internal  role4 = 907588; // ID : 4 , control bitmask: 11011101100101
    uint64 internal  role5 = 42981317; // ID : 5 , control bitmask: 10100011111101011111
    uint64 internal  role6 = 50064774; // ID : 6 , control bitmask: 10111110111110110110
    uint64 internal  role7 = 16195527; // ID : 7 , control bitmask: 111101110001111111
    uint64 internal  role8 = 17545928; // ID : 8 , control bitmask: 1000010111011101011
    uint64 internal  role9 = 32399305; // ID : 9 , control bitmask: 1111011100101111111
    uint64 internal  role10 = 49980106; // ID : 10 , control bitmask: 10111110101010001011
    uint64 internal  role11 = 60415691; // ID : 11 , control bitmask: 11100110011101111011
    uint64 internal  role12 = 48889804; // ID : 12 , control bitmask: 10111010011111111111
    uint64 internal  role13 = 60223053; // ID : 13 , control bitmask: 11100101101110111001
    uint64 internal  role14 = 23575438; // ID : 14 , control bitmask: 1011001111011101110
    uint64 internal  role15 = 55137231; // ID : 15 , control bitmask: 11010010010101001111
    uint64 internal  role16 = 60096464; // ID : 16 , control bitmask: 11100101001111111111
    uint64 internal  role17 = 56535825; // ID : 17 , control bitmask: 11010111101010101100
    uint64 internal  role18 = 35586002; // ID : 18 , control bitmask: 10000111101111111111
    uint64 internal  role19 = 25026515; // ID : 19 , control bitmask: 1011111011101111111
    uint64 internal  dao1Owner = 20; // ID : 20 , control bitmask: 0
 //Events
    ...
    constructor(
        ...
        role_permissions[dao1Owner & 63] = 0;

roles[msg.sender] = dao1Owner;
}
    function initializeCommittees() external {
        require(roles[msg.sender] == dao1Owner && committee_initialization_blocked == false && , "Invalid committee initialization");
