...
class DAOVisitor2(XMLParserVisitor):
    ...
    def visitRole(self, ctx):
        ...
        role = Role(role_id, role_name, role_assignment_method,
    ...
    def visitCommittee(self, ctx):
        ...
        committee = Committee(committee_id, committee_description,
    ...
    def visitDao(self, ctx):
        ...
        hierarchical_inheritance = ctx.hierarchical_inheritance()[
            0].STRING().getText().strip('"')
        dao = DAO(dao_id, dao_name, mission_statement,
