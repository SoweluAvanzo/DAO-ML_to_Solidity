...
class PostProcessingFactory(pb.PipelineItemFactory):
    ...
    def new_solidity(self,
                     phase_step_variant_and_data: AdditionalDataSolidity
    ...
    def new_solidity_hardhat_test(self,
                                  phase_step_variant_and_data: AdditionalDataSolidityHardhatTests
                                  ) -> pb.PipelineItemsGenerated:
    ...
    def new_asm(self,
                phase_step_variant_and_data: AdditionalDataASM
                ) -> pb.PipelineItemsGenerated:
    ...
    def new_json(self,
                 phase_step_variant_and_data: AdditionalDataJSON
                 ) -> pb.PipelineItemsGenerated:
        k_model_generator = phase_step_variant_and_data.k_model_generator
    ...
    def new_pipeline_item_from_variant(self,
        ...
        if phase_step_variant_and_data.phase_step_variant == PostProcessingTransformation.SOLIDITY:
            ...
            return self.new_solidity(phase_step_variant_and_data)
            ...
            return self.new_solidity_hardhat_test(phase_step_variant_and_data)
            ...
            return self.new_asm(phase_step_variant_and_data)
            ...
            return self.new_json(phase_step_variant_and_data)
