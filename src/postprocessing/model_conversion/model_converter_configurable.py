...
class ModelConverterConfigurable(mcb.ModelConverterBase):
    ...
    def get_default_converter_type(self, additional_data:dict=None) -> str:
        ...
        Override-designed
        """
        return ct.ConversionTypes.SOLIDITY.value
    ...
    def get_default_converter_version(self, converter_type:str, additional_data:dict=None) -> str:
        ...
        if c_v is None:
            raise Exception(f"Can't define a proper default converter version for converter type: {converter_type}")
        return c_v
    ...
    def get_converter_version(self, diagram:dm.DiagramManager, converter_type:str, additional_data:dict=None) -> str:
        ...
        if converter_version is None:
            converter_version = self.get_default_converter_version(converter_type, additional_data)
    ...
    def get_default_converter_target(self, converter_type:str, converter_version:str, additional_data:dict=None) -> str:
        ...
        Override-designed
        """
        raise Exception(f"Too much details needed to implement get_default_converter_target for {self.__class__.__name__}")
    ...
    def get_converter_target(self, diagram:dm.DiagramManager, converter_type:str, converter_version:str, additional_data:dict=None) -> str:
        ...
        if converter_target is None:
            converter_target = self.get_default_converter_target(converter_type, converter_version, additional_data)
