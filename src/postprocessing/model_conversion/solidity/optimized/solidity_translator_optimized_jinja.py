...
class TranslatorOptimizedJinja(sol_transl_opt.TranslatorOptimized):
    ...
    def __init__(self, pipeline_item_data: pi.PIData, \
        ...
        #
    """
    TODO: CAN'T IMPORT A DIRECT SUB-CLASS DUE TO CIRCULAR DEPENDENCY ("partially initialized module [of superclass].... has no attribute [subclass]")
