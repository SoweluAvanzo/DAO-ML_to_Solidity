...
def main(
    ...
    source_filename = "Travelhive_final_model" if source_filename_default is None else source_filename_default
    EXTENSION_XML = "xml"
    ...
    folder_output = files.concat_folder_filename(
        '.', 'out') if output_folder_default is None else output_folder_default
...
if __name__ == "__main__":
    args: cmd_args.CmdConfigs = cmd_args.get_args()
